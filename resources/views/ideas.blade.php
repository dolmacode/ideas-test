       ...
       <div class="_container">
          <div class="page-header__body">
             ...
             <div class="page-header__actions">
                <a href="{{ route('page.create.category') }}" class="btn btn__main">Добавить категорию</a>
          ...
          <table class="table with-action">
             ...
             <tbody>
                ...
                <tr>
                   ...
                   <td>{{ count(App\Models\Idea::where('category_id', $item->id)->get()->all()) }}</td>
                   <td>{{ $item->favs }}</td>
                   <td>{{ $item->status }}</td>
                   <td>
                      <div>
                         <a href="{{ route('category.edit', ['id' => $item->id]) }}"><svg><use xlink:href="{{ asset('img/sprite.svg') }}#arrow"></use></svg></a>
                         <a href="{{ route('category.delete', ['id' => $item->id]) }}"><svg><use xlink:href="{{ asset('img/sprite.svg') }}#close"></use></svg></a>
                      </div>
                   </td>
                </tr>
                @endforeach
